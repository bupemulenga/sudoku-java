package com.sudoku.javadesktopsudoku.interfaces;

import com.sudoku.javadesktopsudoku.constants.GameState;
import com.sudoku.javadesktopsudoku.models.Coordinates;
import com.sudoku.javadesktopsudoku.models.SudokuGame;
...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    public UserInterfaceImpl(Stage stage, Group group) {
        this.stage = stage;
        this.root = new Group();
    ...
    // Add user interface look and feel
    ...
    private static final String SUDOKU_TITLE = "Sudoku";
